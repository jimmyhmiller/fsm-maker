...
return cljs.core._write(writer__8271__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__16499 = o;
(G__16499[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__16500__delegate = function (args){
...
while (G__16501__i < G__16501__a.length) {G__16501__a[G__16501__i] = arguments[G__16501__i + 0]; ++G__16501__i;}
  args = new cljs.core.IndexedSeq(G__16501__a,0,null);
} 
...
var args = cljs.core.seq(arglist__16502);
...
var G__16505 = jsprops;
(G__16505["defaultValue"] = value);

(G__16505["onChange"] = ((function (G__16505,v,value,on_change){
return (function (p1__16504_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__16504_SHARP_);
});})(G__16505,v,value,on_change))
);
...
var vec__16508 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16508,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16508,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16508,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___16512 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___16512 == null)){
} else {
var key_16513 = temp__4661__auto___16512;
(jsprops["key"] = key_16513);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__16514 = reagent.impl.template.__GT_NativeWrapper();
(G__16514["name"] = c);
...
var G__16515 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__16515) : reagent.impl.template.as_element.call(null,G__16515));
} else {
...
var len__8814__auto___16520 = arguments.length;
var i__8815__auto___16521 = (0);
while(true){
if((i__8815__auto___16521 < len__8814__auto___16520)){
args__8821__auto__.push((arguments[i__8815__auto___16521]));

var G__16522 = (i__8815__auto___16521 + (1));
i__8815__auto___16521 = G__16522;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq16518){
var G__16519 = cljs.core.first(seq16518);
var seq16518__$1 = cljs.core.next(seq16518);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__16519,seq16518__$1);
});
...
break;
default:
var G__16525 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__16525;
continue;
...
var n__8590__auto___16527 = a.length;
var i_16528 = (0);
while(true){
if((i_16528 < n__8590__auto___16527)){
(a[i_16528] = reagent.impl.template.as_element((a[i_16528])));

var G__16529 = (i_16528 + (1));
i_16528 = G__16529;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8590__auto___16530 = a.length;
var i_16531 = (0);
while(true){
if((i_16531 < n__8590__auto___16530)){
var val_16532 = (a[i_16531]);
if((cljs.core.vector_QMARK_(val_16532)) && ((reagent.impl.template.key_from_vec(val_16532) == null))){
(o["no-key"] = true);
} else {
}

(a[i_16531] = reagent.impl.template.as_element(val_16532));

var G__16533 = (i_16531 + (1));
i_16531 = G__16533;
continue;
} else {
}
...
var ctx = ({});
var vec__16534 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16534,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16534,(1),null);
...
var G__16537 = (cljs.core.count(argv) - first_child);
switch (G__16537) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__16537){
