...
var len__38918__auto___53208 = arguments.length;
var i__38919__auto___53209 = (0);
while(true){
if((i__38919__auto___53209 < len__38918__auto___53208)){
args__38925__auto__.push((arguments[i__38919__auto___53209]));

var G__53210 = (i__38919__auto___53209 + (1));
i__38919__auto___53209 = G__53210;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__38926__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq53205){
var G__53206 = cljs.core.first.call(null,seq53205);
var seq53205__$1 = cljs.core.next.call(null,seq53205);
var G__53207 = cljs.core.first.call(null,seq53205__$1);
var seq53205__$2 = cljs.core.next.call(null,seq53205__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__53206,G__53207,seq53205__$2);
});
...
if(cljs.core.truth_((function (){var or__37749__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__38374__auto__,writer__38375__auto__,opt__38376__auto__){
return cljs.core._write.call(null,writer__38375__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__37737__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__37737__auto__){
var or__37749__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__37749__auto__)){
return or__37749__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__53211_SHARP_){
return !((cljs.core.meta.call(null,p1__53211_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__53212__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__37749__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e53216){var _e__46776__auto__ = e53216;
return false;
}})();
if(cljs.core.truth_(or__37749__auto__)){
return or__37749__auto__;
...
}catch (e53218){var _e__46776__auto__ = e53218;
return false;
}}
})())){
...
var _STAR_current_state_STAR_53220 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__53221 = opts;
...
var markup_db = cljs.core.get.call(null,map__53221__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_53220;
}});
...
;
var temp__4655__auto___53225 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___53225)){
var managed_print_level_53226 = temp__4655__auto___53225;
var _STAR_print_level_STAR_53224_53227 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_53226;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_53224_53227,managed_print_level_53226,temp__4655__auto___53225,writer,opts,job_fn){
return (function (p1__53223_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__53223_SHARP_,null);
});})(_STAR_print_level_STAR_53224_53227,managed_print_level_53226,temp__4655__auto___53225,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_53224_53227;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1507178387608
