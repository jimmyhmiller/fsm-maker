...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__38374__auto__,writer__38375__auto__,opt__38376__auto__){
return cljs.core._write.call(null,writer__38375__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__55739 = o;
(G__55739[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__55740__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__55740 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__55741__i = 0, G__55741__a = new Array(arguments.length -  0);
while (G__55741__i < G__55741__a.length) {G__55741__a[G__55741__i] = arguments[G__55741__i + 0]; ++G__55741__i;}
  args = new cljs.core.IndexedSeq(G__55741__a,0,null);
} 
return G__55740__delegate.call(this,args);};
G__55740.cljs$lang$maxFixedArity = 0;
G__55740.cljs$lang$applyTo = (function (arglist__55742){
var args = cljs.core.seq(arglist__55742);
return G__55740__delegate(args);
});
G__55740.cljs$core$IFn$_invoke$arity$variadic = G__55740__delegate;
return G__55740;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__37737__auto__ = !((jsprops == null));
if(and__37737__auto__){
var and__37737__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__55745 = jsprops;
(G__55745["defaultValue"] = value);

(G__55745["onChange"] = ((function (G__55745,v,value,on_change){
return (function (p1__55744_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__55744_SHARP_);
});})(G__55745,v,value,on_change))
);
...
var vec__55748 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__55748,(0),null);
var id = cljs.core.nth.call(null,vec__55748,(1),null);
var class$ = cljs.core.nth.call(null,vec__55748,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___55752 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___55752 == null)){
} else {
var key_55753 = temp__4661__auto___55752;
(jsprops["key"] = key_55753);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__55754 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__55754["name"] = c);
...
var len__38918__auto___55759 = arguments.length;
var i__38919__auto___55760 = (0);
while(true){
if((i__38919__auto___55760 < len__38918__auto___55759)){
args__38925__auto__.push((arguments[i__38919__auto___55760]));

var G__55761 = (i__38919__auto___55760 + (1));
i__38919__auto___55760 = G__55761;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__38926__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq55757){
var G__55758 = cljs.core.first.call(null,seq55757);
var seq55757__$1 = cljs.core.next.call(null,seq55757);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__55758,seq55757__$1);
});
...
break;
default:
var G__55764 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__55764;
continue;
...
var n__38694__auto___55766 = a.length;
var i_55767 = (0);
while(true){
if((i_55767 < n__38694__auto___55766)){
(a[i_55767] = reagent.impl.template.as_element.call(null,(a[i_55767])));

var G__55768 = (i_55767 + (1));
i_55767 = G__55768;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__38694__auto___55769 = a.length;
var i_55770 = (0);
while(true){
if((i_55770 < n__38694__auto___55769)){
var val_55771 = (a[i_55770]);
if((cljs.core.vector_QMARK_.call(null,val_55771)) && ((reagent.impl.template.key_from_vec.call(null,val_55771) == null))){
(o["no-key"] = true);
} else {
}

(a[i_55770] = reagent.impl.template.as_element.call(null,val_55771));

var G__55772 = (i_55770 + (1));
i_55770 = G__55772;
continue;
} else {
}
...
var ctx = ({});
var vec__55773 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__55773,(0),null);
var derefed = cljs.core.nth.call(null,vec__55773,(1),null);
...
var G__55776 = (cljs.core.count.call(null,argv) - first_child);
switch (G__55776) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__55776){
...
//# sourceMappingURL=template.js.map?rel=1507178392528
