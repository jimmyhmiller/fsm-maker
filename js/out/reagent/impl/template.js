...
var G__45742 = o;
(G__45742[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__45748 = jsprops;
(G__45748["defaultValue"] = value);

(G__45748["onChange"] = ((function (G__45748,v,value,on_change){
return (function (p1__45747_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__45747_SHARP_);
});})(G__45748,v,value,on_change))
);
...
var vec__45751 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__45751,(0),null);
var id = cljs.core.nth.call(null,vec__45751,(1),null);
var class$ = cljs.core.nth.call(null,vec__45751,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___45755 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___45755 == null)){
} else {
var key_45756 = temp__4661__auto___45755;
(jsprops["key"] = key_45756);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__45757 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__45757["name"] = c);
...
var len__38918__auto___45762 = arguments.length;
var i__38919__auto___45763 = (0);
while(true){
if((i__38919__auto___45763 < len__38918__auto___45762)){
args__38925__auto__.push((arguments[i__38919__auto___45763]));

var G__45764 = (i__38919__auto___45763 + (1));
i__38919__auto___45763 = G__45764;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq45760){
var G__45761 = cljs.core.first.call(null,seq45760);
var seq45760__$1 = cljs.core.next.call(null,seq45760);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__45761,seq45760__$1);
});
...
break;
default:
var G__45767 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__45767;
continue;
...
var n__38694__auto___45769 = a.length;
var i_45770 = (0);
while(true){
if((i_45770 < n__38694__auto___45769)){
(a[i_45770] = reagent.impl.template.as_element.call(null,(a[i_45770])));

var G__45771 = (i_45770 + (1));
i_45770 = G__45771;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__38694__auto___45772 = a.length;
var i_45773 = (0);
while(true){
if((i_45773 < n__38694__auto___45772)){
var val_45774 = (a[i_45773]);
if((cljs.core.vector_QMARK_.call(null,val_45774)) && ((reagent.impl.template.key_from_vec.call(null,val_45774) == null))){
(o["no-key"] = true);
} else {
}

(a[i_45773] = reagent.impl.template.as_element.call(null,val_45774));

var G__45775 = (i_45773 + (1));
i_45773 = G__45775;
continue;
} else {
}
...
var ctx = ({});
var vec__45776 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__45776,(0),null);
var derefed = cljs.core.nth.call(null,vec__45776,(1),null);
...
var G__45779 = (cljs.core.count.call(null,argv) - first_child);
switch (G__45779) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__45779){
...
//# sourceMappingURL=template.js.map?rel=1507334719190
