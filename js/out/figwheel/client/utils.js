...
var or__37749__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj58959 = {"detail":data};
return obj58959;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__37737__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__37737__auto__)){
var and__37737__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__58966 = cljs.core._EQ_;
var expr__58967 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__58966.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__58967))){
return ((function (pred__58966,expr__58967){
return (function (p1__58960_SHARP_){
return console.warn(p1__58960_SHARP_);
});
;})(pred__58966,expr__58967))
} else {
if(cljs.core.truth_(pred__58966.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__58967))){
return ((function (pred__58966,expr__58967){
return (function (p1__58961_SHARP_){
return console.debug(p1__58961_SHARP_);
});
;})(pred__58966,expr__58967))
} else {
if(cljs.core.truth_(pred__58966.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__58967))){
return ((function (pred__58966,expr__58967){
return (function (p1__58962_SHARP_){
return console.error(p1__58962_SHARP_);
});
;})(pred__58966,expr__58967))
} else {
return ((function (pred__58966,expr__58967){
return (function (p1__58963_SHARP_){
return console.log(p1__58963_SHARP_);
});
;})(pred__58966,expr__58967))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__58970){
var map__58971 = p__58970;
var map__58971__$1 = ((((!((map__58971 == null)))?((((map__58971.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58971.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__58971):map__58971);
var opts = map__58971__$1;
var eval_fn = cljs.core.get.call(null,map__58971__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__58973_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__58975,(0),null);
var v = cljs.core.nth.call(null,vec__58975,(1),null);
...
if(cljs.core.truth_((function (){var and__37737__auto__ = typeof localStorage !== 'undefined';
...
}catch (e58980){if((e58980 instanceof Error)){
var e = e58980;
return not_found;
} else {
throw e58980;
...
//# sourceMappingURL=utils.js.map?rel=1507178397348
