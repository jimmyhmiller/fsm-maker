...
var and__37737__auto__ = !(("#" === ch));
if(and__37737__auto__){
var and__37737__auto____$1 = !(("'" === ch));
if(and__37737__auto____$1){
var and__37737__auto____$2 = !((":" === ch));
...
if(cljs.core.truth_((function (){var and__37737__auto__ = validate_leading_QMARK_;
...
var G__58825 = (function (){var G__58823 = sb;
G__58823.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__58823;
})();
var G__58826 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__58825;
ch = G__58826;
continue;
}
...
var temp__4655__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__58827 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__58827,ch);
...
var or__37749__auto____$1 = cljs.tools.reader.edn.macros.call(null,ch);
...
var vec__58835 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__58835,(0),null);
var start_column = cljs.core.nth.call(null,vec__58835,(1),null);
...
var G__58839 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__58839;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__58838 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__58838,ch);

return G__58838;
})(),true,null,opts);
var G__58840 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__58840;
continue;
}
}
...
var vec__58841 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
...
var sb = (function (){var G__58844 = (new goog.string.StringBuffer());
G__58844.append(initch);
...
var G__58846 = (function (){var G__58845 = sb;
G__58845.append(ch);

return G__58845;
})();
var G__58847 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__58846;
ch = G__58847;
continue;
}
...
while(true){
var G__58850 = ch;
if(cljs.core._EQ_.call(null,null,G__58850)){
...
if(cljs.core._EQ_.call(null,"\\",G__58850)){
var G__58853 = (function (){var G__58851 = sb;
G__58851.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__58851;
})();
var G__58854 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__58853;
ch = G__58854;
continue;
} else {
...
var G__58855 = (function (){var G__58852 = sb;
G__58852.append(ch);

return G__58852;
})();
var G__58856 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__58855;
ch = G__58856;
continue;
...
break;
default:
var or__37749__auto__ = (function (){var temp__4657__auto____$1 = cljs.tools.reader.impl.commons.parse_symbol.call(null,token);
...
return cljs.core._conj.call(null,(function (){var x__38611__auto____$1 = cljs.tools.reader.edn.read.call(null,rdr,true,null,opts);
...
var G__58860 = rdr;
cljs.tools.reader.edn.read.call(null,G__58860,true,null,true);
...
var temp__4655__auto__ = (function (){var G__58861 = token;
var G__58861__$1 = (((G__58861 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__58861));
if((G__58861__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__58861__$1);
}
})();
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4655__auto__ = (function (){var or__37749__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"readers","readers",-2118263030).cljs$core$IFn$_invoke$arity$1(opts),tag);
if(cljs.core.truth_(or__37749__auto__)){
return or__37749__auto__;
} else {
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__58868,reader){
var map__58869 = p__58868;
var map__58869__$1 = ((((!((map__58869 == null)))?((((map__58869.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58869.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__58869):map__58869);
var opts = map__58869__$1;
var eof = cljs.core.get.call(null,map__58869__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
//# sourceMappingURL=edn.js.map?rel=1507178397176
